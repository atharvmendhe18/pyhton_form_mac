...
class Minesweeper:
    ...
    print("Initilizating a minesweeper board")
...
class Sentence:
    ...
    def mark_mine(self, cell):
        ...
        if cell in self.cells:
            print("usinf mark_mine functin in Sentence classs")
    ...
    def mark_safe(self, cell):
        ...
        """
        if cell in self.cells:
            print("usinf mark_safe functin in Sentence classs")
            self.cells.remove(cell)
...
class MinesweeperAI:
    ...
    def mark_mine(self, cell):
        ...
        """
        print("usinf mark_mine functin in MinesweepertAI classs")
        self.mines.add(cell)
    ...
    def mark_safe(self, cell):
        ...
        """
        print("usinf mark_safe functin in MinesweepertAI classs")
        self.safes.add(cell)
        for sentence in self.knowledge:
    ...
    def add_knowledge(self, cell, count):
        ...
        """
        print("Using add_knowledge function")
        # 1st step
        ...
        for sentence in self.knowledge:
            safe_cells_to_be_removed = []
            mine_cells_to_be_removed = []
            set_cell = sentence.cells
            if sentence.count == 0 and len(set_cell) != 0:
                for cell in set_cell:
                    safe_cells_to_be_removed.append(cell)

            for cell in safe_cells_to_be_removed:
                self.mark_safe(cell)

            if sentence.count == len(set_cell):
                for cell in set_cell:
                    mine_cells_to_be_removed.append(cell)

            for cell in mine_cells_to_be_removed:
                self.mark_mine(cell)
        ...
        # there are a lot i mean a lot of sentences in the knowledge base, ig that is csusing the problem
